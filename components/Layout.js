...
function Layout({ children }) {
    return (
        <main className="relative w-screen h-screen overflow-x-hidden transition-all bg-black scroll-smooth">
            <div className="fixed -translate-y-1/2 top-1/2 -left-36 md:-left-16">
                <Image src={circle} alt="circle" width={200} height={200} />
            </div>
            <Navbar />
            <div className='relative pt-16 w-[80%] min-h-screen md:w-[75%] mx-auto px-5 py-3 md:px-10 before:absolute before:h-full before:z-0 before:w-screen before:bg-white/5 before:blur-md before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2'>
                {children}
            ...
            <div className="fixed -translate-y-1/2 top-1/2 -right-36 md:-right-16">
                <Image src={circle} alt="circle" width={200} height={200} />
            </div>
        </main>
    )
